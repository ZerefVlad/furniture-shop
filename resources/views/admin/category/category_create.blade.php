        ...
        <div class="col-12 col-md-12 user-item">
            ...
            <div class="users-info">
                ...
                <form enctype="multipart/form-data" method="post"
                      action="@if ($action === 'edit') {{route('category_edit', ['category' => $category])}} @else {{route('category_create')}} @endif" class="change-form ">
...
{{--                        </li>--}}
                        ...
                        <li class="list-item col-md-12">
                            ...
                            @if ($image)
                                <a href="{{route('category_delete_picture', ['category' => $category])}}">Удалить картинку</a>
                            @endif

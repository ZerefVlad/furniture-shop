...
$('#picture-add-main-page').click(function (e) {
    ...
    div.append(
        '<div class="col-md-12">' +
        '<input form="main-page-update-form"  type="text" name="img_alt['+counter+']">' +
        '<input form="main-page-update-form"  type="text" name="img_title['+counter+']">' +
        '<input form="main-page-update-form"  type="file" name="pictures['+counter+']" id="img-'+counter+'" class="img-input">' +
        '<img src="#" id="loader-'+counter+'" class="load-image" alt="">' +
        '</div>'
    );
});
